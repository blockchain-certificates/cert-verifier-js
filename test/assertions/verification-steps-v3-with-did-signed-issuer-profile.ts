...
export default [
  ...
  },
  {
    ...
    subSteps: [
      {
        code: SUB_STEPS.verifyIssuerProfile,
        label: defaultLanguageSet.subSteps.verifyIssuerProfileLabel,
        labelPending: defaultLanguageSet.subSteps.verifyIssuerProfileLabelPending,
