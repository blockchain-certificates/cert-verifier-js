...
describe('domain certificates get chain use case test suite', () => {
  describe('given it is called with a signature with anchors', () => {
    describe('given the first anchor has a chain property', () => {
    ...
    describe('given the first anchor does not have a chain property', () => {
