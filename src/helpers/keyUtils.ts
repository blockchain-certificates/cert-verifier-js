...
export const publicKeyHexFromJwkSecp256k1 = (jwk: ISecp256k1PublicKeyJwk): string => {
...
export function jwkToPublicKeyBytesEd25519(jwk) {
  const {kty, crv, x} = jwk;
  if(kty !== 'OKP') {
...
export const jwkToMultibaseEd25519 = (jwk: ISecp256k1PublicKeyJwk): string => {
