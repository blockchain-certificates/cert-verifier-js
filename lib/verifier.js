...
const CONTEXTS = {};
var OBI_CONTENT = fs.readFileSync(__dirname + "/contexts/obi.json", 'utf-8');
var OBI_CONTEXT = JSON.parse(OBI_CONTENT);
var BLOCKCERTS_CONTENT = fs.readFileSync(__dirname + "/contexts/blockcerts.json", 'utf-8');
var BLOCKCERTS_CONTEXT = JSON.parse(BLOCKCERTS_CONTENT);
var BLOCKCERTSV2_CONTENT = fs.readFileSync(__dirname + "/contexts/blockcertsv2.json", 'utf-8');
