import { versionParserMap } from '../index.js';
import type { JsonLDContext } from '../../models/Blockcerts.js';
import { isString } from '../../helpers/string.js';
import Versions from '../../constants/certificateVersions.js';
