...
import { Blockchain, PublicKey, CertificateVersion } from '../config/default';

require('string.prototype.startswith');


var getChainForAddress = function (bitcoinAddress) {
...
var getChain = function (signature, bitcoinAddress) {
  let anchorType = signature.anchors[0].type;
